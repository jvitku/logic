...
independent=True, useQuick=True):
    ...
    g.addNode(finder, "logic_gates_XOR", "java");      # start java node and name it finder

    neuron = NeuralModule(name+"_logic_gates_xor", g) # construct the neural module 
